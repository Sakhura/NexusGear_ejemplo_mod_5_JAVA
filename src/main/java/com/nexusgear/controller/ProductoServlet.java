...
public class ProductoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        switch (accion) {
            ...
            case "nuevo":
                ...
                req.getRequestDispatcher("/views/producto/form.jsp").forward(req, res);
                break;
    ...
    private void listar(HttpServletRequest req, HttpServletResponse res)
        ...
        req.getRequestDispatcher("/views/producto/lista.jsp").forward(req, res);
    }
    ...
    private void detalle(HttpServletRequest req, HttpServletResponse res)
        ...
        req.setAttribute("producto", p);
        req.getRequestDispatcher("/views/producto/detalle.jsp").forward(req, res);
    }
